...
class __TwigTemplate_93c01a05191baa4666b547f56443ecaf extends Template
{
    ...
    <div class=\"flex h-screen\">
        ...
        <aside class=\"w-64 bg-gradient-to-b from-purple-900 to-purple-800 text-white flex flex-col shadow-xl\">
            ...
            <nav class=\"flex-1 p-4 space-y-2\">
                ...
                <a href=\"/manicures\" class=\"w-full flex items-center gap-3 px-4 py-3 rounded-lg hover:bg-purple-700 transition\">
...
<body class=\"font-inter bg-gray-50\">
    <div class=\"flex h-screen\">
        ...
        <!-- Main Content -->
        {% block content %}
        <h1>Bemv-vindo ao BeautyBook</h1>
        {% endblock %}
    </div>
...
</html>", "layout/base.html.twig", "/var/www/html/src/Views/layout/base.html.twig");
    }
}
